 ...
 * Use the [RestingFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class RestingFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_resting, container, false)
        val timestamp = System.currentTimeMillis()
        val format = SimpleDateFormat("yyyy-MM-dd HH:mm:ss", Locale.getDefault())
        val militarytime = format.format(Date(timestamp))
        val context = requireContext()

        val starter = view.findViewById<Button>(R.id.startsesResting)
        val ender = view.findViewById<Button>(R.id.endsesResting)
        val check = view.findViewById<CheckBox>(R.id.checkBoxResting)
        val fileDescription = view.findViewById<TextView>(R.id.FileDescriptionResting)
    ...
    companion object {
         ...
         * @return A new instance of fragment RestingFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            RestingFragment().apply {
